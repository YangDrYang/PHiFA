function [d1,d2,N,nmin] = fulfilConstrains(D1,D2,wvl,Dz,r0sw,R,d1max,d2max)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

Npowmax = 10;
Nmin = 64; % sufficient minimum resolution
c = 3;
...
% constraint 3 + 1
d1 = wvl*Dz/D1p/(1+Dz/R+D2p/D1p); % built-in constraint 3
d2 = deltan_max(d1);
