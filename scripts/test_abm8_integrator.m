...
initstate.n_log_only_every_xth_step = 5;
...
if ~station.bGroundBased
    station.intstep = 1; % if space-borne, to set for orbit integration step
end
...
propagator.station.referencePower = 10000;
