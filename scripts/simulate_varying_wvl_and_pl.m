...
pulselengths = [0.1, 1, 3, 10]*10^-9;
wavelengths = (300:200:1500)*10^-9;

for i = 1:length(pulselengths)
    propagator.station.PulseLength = pulselengths(i);
    for j = 1:length(wavelengths)
        propagator.station.Wavelength = wavelengths(j);
        ...
        dim_describ = ["pulselengths ", num2str(pulselengths(i)); ...
            "wavelengths ", num2str(wavelengths(j)); ...
